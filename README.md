...
- [ ] Провести рефакторинг, максимально отвязат любые конфигурируемые данные от кода (вынести в конфигурации);
- [ ] Добавить Healthcheck для Postgresql-сервиса в [docker-compose.yaml](./docker-compose.yaml)
- [ ] Перевести версию Gradle с 9.10 на 8.14 (при необходимости);
- [ ] Подумать валидацией отправляемых сообщений:
